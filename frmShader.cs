...
namespace WinOpenGL_ShaderToy
{
	public partial class frmShader : DockContent
	{
		...
		private static Style styleAccessModifiers = new TextStyle(new SolidBrush(Color.FromArgb(0x00, 0x80, 0xFF)), null, FontStyle.Regular);
		private static Style styleGLTypes = new TextStyle(new SolidBrush(Color.FromArgb(0x40, 0x80, 0x80)), null, FontStyle.Regular);
		private static Style styleCodeFlow = new TextStyle(new SolidBrush(Color.FromArgb(0xC4, 0x62, 0x00)), null, FontStyle.Regular);
		private static Style styleGLInputOutput = new TextStyle(new SolidBrush(Color.FromArgb(0x80, 0x80, 0xFF)), null, FontStyle.Regular);
		private static Style styleGLKeywords = new TextStyle(new SolidBrush(Color.FromArgb(0x00, 0x00, 0x00)), null, FontStyle.Regular);
		private static Style styleBuiltInFunctions = new TextStyle(new SolidBrush(Color.FromArgb(0xFF, 0x80, 0x40)), null, FontStyle.Regular);
